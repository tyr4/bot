...
calc_command_list_2 = "**/calc dungeon_gold** - Input your dungeon data to receive the best way to spend your keys, given a Day target.\n" \
                      "**/commands calc** - The command you just used!"

fun_command_list = "**/fun stab** - Stabs a user of your choice\n" \
      "**/fun pet** - Pets an user of your choice\n" \
      "**/fun defender_outfit** - Dresses up the Defender with gear of your choice\n" \
      "**/fun random_defender_outfit** - Dresses up the Defender with random gear of your choice\n" \
      "**/commands fun** - The command you just used!"
...
command_list = "**/commands troubleshooting** - Provides a list of all commands related to Troubleshooting\n" \
               ...
               "**/commands fun** - Provides a list of all commands related to Fun\n" \
...
class Commands(commands.GroupCog, name="commands"):
    ...
    async def calc(self, interaction: discord.Interaction) -> None:
        ...
        embed.add_field(name="", value=calc_command_list_2, inline=False)
        embed.set_footer(text="If you spot any issues with this bot, please ping '@_tyrael.'",
                         icon_url="https://cdn.discordapp.com/emojis/1139252590278889529.gif")
        await interaction.response.send_message(embed=embed, ephemeral=True)
    
    @app_commands.command(name="fun", description="Provides a list of all commands related to Fun (images and such)")
    async def funni(self, interaction: discord.Interaction) -> None:
        embed = discord.Embed(title="List of all available Calculator commands", color=0x71368a)
        embed.add_field(name="", value=fun_command_list, inline=False)
        embed.set_footer(text="If you spot any issues with this bot, please ping '@_tyrael.'",
                         icon_url="https://cdn.discordapp.com/emojis/1139252590278889529.gif")
        await interaction.response.send_message(embed=embed, ephemeral=True)
